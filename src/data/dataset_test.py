...
class FingerprintDataset(Dataset):
    def __init__(self, fingerprint_dir,  limit=-1, seq_length=1000):
        ...
        # Add random_crop, into params if req and uncomment tf1
        ...
        # ])
        self.tf1 = transforms.RandomRotation(45)
    ...
    def __getitem__(self, index):
        ...
        training_map = full_map[:self.seq_length, 12:-12, 12:-12] #original [:1000, : , : ], for mainfang_updated, use [:600, : , :]
        ground_map = full_map[1000:-1, 12:-12, 12:-12]
